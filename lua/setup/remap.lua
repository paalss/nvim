...
-- resize panes
vim.keymap.set("n", "<leader><Up>", "<cmd>resize -12<CR>", { desc = "Resize split up" })
vim.keymap.set("n", "<leader><Down>", "<cmd>resize +12<CR>", { desc = "Resize split down" })
vim.keymap.set("n", "<leader><Left>", "<cmd>vertical resize -12<CR>", { desc = "Resize split left" })
vim.keymap.set("n", "<leader><Right>", "<cmd>vertical resize +12<CR>", { desc = "Resize split right" })
