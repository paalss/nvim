...
-- Git history
vim.keymap.set("n", "<leader>dh", ":DiffviewFileHistory<CR>", { desc = "Show commit history (Diffview)" })
vim.keymap.set("n", "<leader>dj", ":DiffviewFileHistory %<CR>", { desc = "Show commit history for current file (Diffview)" })
