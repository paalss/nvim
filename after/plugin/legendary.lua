...
legendary.setup({
  ...
  keymaps = {
    ...
    { "<leader>harp",   description = "add to harpoon" },
    { "K",              description = "show buf" },
    { "<leader>vd",     description = "open diagnostic" },
    { "<leader>vca",    description = "code action" },
    { "<leader>vrr",    description = "code references" },
    { "<leader>vrn",    description = "rename" },
    { "<leader>help",   description = "help" },
  }
})
