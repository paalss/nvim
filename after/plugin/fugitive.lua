...
vim.keymap.set("n", "\\gr", ":Gdiffsplit ...main", { desc = "Compare with main (Fugitive)" })
vim.keymap.set("n", "\\gy", ":Gdiffsplit ...master", { desc = "Compare with master (Fugitive)" })
vim.keymap.set("n", "\\gt", ":Gdiffsplit ...develop", { desc = "Compare with develop (Fugitive)" })
